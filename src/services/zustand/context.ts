import { createContext as reactCreateContext, createElement, useContext, useRef, type ReactNode } from "react"
...
function createContext<
  ...
  TUseBoundStore extends UseBoundStore<StoreApi<object>> = UseBoundStore<StoreApi<object>>,
>() {
  const ZustandContext = reactCreateContext<TUseBoundStore | undefined>(undefined)

  const Provider = ({ createStore, children }: { createStore: () => TUseBoundStore; children: ReactNode }) => {
